angular.module('MyApp')
  .controller('DetailCtrl', ['$scope', '$rootScope', '$routeParams', 'Show', 'Subscription',
    function($scope, $rootScope, $routeParams, Show, Subscription) {
      Show.get({ _id: $routeParams.id }, function(show) {  //get a single show
        $scope.show = show;
...
/**
Show.get() -> get a single show
Show.Query() -> get a list of shows  
Note that we are not handling any HTTP requests inside the controller.
